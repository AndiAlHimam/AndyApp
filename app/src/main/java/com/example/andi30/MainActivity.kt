...
class MainActivity : AppCompatActivity() {
    ...
    private fun isiGambar( txtHello: TextView, image1: ImageView){
        ...
        when (tes) {
            1 -> image1.setImageDrawable(getDrawable(R.drawable.team1))
            2 -> image1.setImageDrawable(getDrawable(R.drawable.team2))
            3 -> image1.setImageDrawable(getDrawable(R.drawable.team3))
            4 -> image1.setImageDrawable(getDrawable(R.drawable.team4))
            5 -> image1.setImageDrawable(getDrawable(R.drawable.team5))
            else -> { // Note the block
                image1.setImageDrawable(getDrawable(R.drawable.team6))
            }
        }
    }
